...
const FooterBanner = ({ footerBanner: { discount, largeText1, largeText2, saleTime, smallText, midText, desc, product, buttonText, image } }) => {
  return (
    <div className="bg-gray-800 text-white py-16 px-4 sm:px-8 md:px-16 relative mt-5">
        ...
        <div className="lg:w-1/3 text-center lg:text-left mb-8 lg:mb-0">
          ...
          <div className="mt-6">
            <Link href={`/product/${product}`}>
              <button type="button" className="px-8 py-3 bg-red-600 text-white text-lg font-medium rounded-md hover:bg-red-700 transition-colors">
                {buttonText}
              </button>
            </Link>
          </div>
